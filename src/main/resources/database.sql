...
create table medicines(
                          ...
                          category_id int,
                          foreign key (category_id) references categories_med(category_id)
);
...
-- 3. Doctors
INSERT INTO doctors (first_name, last_name, license_number, telephone, email, post_code, address) VALUES
                                                                                                      ('Jean', 'Dupont', 'LIC12345', '0102030405', 'jean.dupont@example.com', '75001', '10 Rue de Rivoli'),
                                                                                                      ('Marie', 'Durand', 'LIC67890', '0607080910', 'marie.durand@example.com', '69001', '20 Rue de la République');

-- 4. Insurances
INSERT INTO insurances (insurance_name, telephone, email, post_code, address, department_id) VALUES
                                                                                                 ('Assurance Santé Paris', '0145789632', 'contact@assuranceparis.fr', '75001', '15 Avenue des Champs-Élysées', 1),
                                                                                                 ('Assurance Lyon', '0478123456', 'contact@assurancelyon.fr', '69001', '25 Rue de Lyon', 2);

-- 5. Patients
INSERT INTO patients (first_name, last_name, social_sec_number, telephone, email, post_code, address, insurance_id, doctor_id) VALUES
                                                                                                                                   ('Pierre', 'Martin', 'SS123456789', '0612345678', 'pierre.martin@example.com', '75002', '5 Rue Saint-Honoré', 1, 1),
                                                                                                                                   ('Sophie', 'Bernard', 'SS987654321', '0678901234', 'sophie.bernard@example.com', '69002', '10 Rue Victor Hugo', 2, 2);
...
INSERT INTO prescription_meds (prescription_id, medicine_id) VALUES
                                                                 (1, 1),  -- Pierre received Amoxicillin
                                                                 (2, 2);  -- Sophie received Ibuprofen

-- 10. Purchase_Meds
INSERT INTO purchase_meds (purchase_id, medicine_id) VALUES
                                                         (1, 1),  -- Pierre bought Amoxicillin
                                                         (2, 2);  -- Sophie bought Ibuprofen
